...
import com.user.superanimator.adapter.GoodsAdapter;
import com.user.superanimator.model.GoodsModel;

import java.util.ArrayList;


/**
 * @className: BezierShoppingActivity
 * @classDescription: 购物车页
 */
public class BezierShoppingActivity extends AppCompatActivity {
    // 购物车父布局
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bezier_shop);
        // findView
